...
;  p5.yrange=[0,1.4]
  ...
  ;for LWC
  if type eq 'lwc' then p2=plot(massmeansorted,coleliqsorted,color='blue',thick=2,linestyle=2,dimensions=[1200,1200],margin=[110,70,30,20],/device)
  ...
  ;for TWC2
  if type eq 'twc2' then p4=plot(massmeansorted,colelwcsorted,color='green',thick=2,linestyle=2,dimensions=[1200,1200],margin=[110,70,30,20],/device,/overplot)
